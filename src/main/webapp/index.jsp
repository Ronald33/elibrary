    ...
    <body ng-app="app" ng-controller="ultimos">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="" ng-click="irIndice()">Indice</a>
                        </li>
                        <li>
                            <a href="#">Creditos</a>
                        </li>
                        <li>
                            <a href="editor/login">Soy editor</a>
                        </li>
                        <%
                            if(request.getSession().getAttribute("nombres") == null)
                            {
                    ...
                    <div class="col-sm-3 col-md-3 pull-right">
                        <form class="navbar-form" role="search">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Buscar ..." name="q" ng-model="key">
        ...
        <div class="container" id="arriba">
                    ...
                    <div class="col-sm-12">
                        <form action="">
                            ...
                            <div class="col-sm-1">
                                ...
                                <button class="btn" type="button" ng-click="comentar(<%=id%>)" ng-disabled="!comentario.texto">Comentar</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row text-center" id="ultimos">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3>Ultimos libros agregados</h3>
                    </div>
                </div>
                <!-- /.row -->
                <div class="col-md-4 col-sm-6 hero-feature" ng-repeat="libro in libros| filter:key">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>
                                <a href="" class="btn btn-primary" ng-click="detalles(libro.id)">Detalles</a> 
                                <a target="_blank" href="<%=baseURL%>{{libro.link}}" class="btn btn-default">Descargar</a>
                            </p>
                        </div>
                    </div>
                </div>
